...
public class PP2Problema19 {
    ...
    public static void mostrarResultado(double a){
        ...
        System.out.println("El coseno de "+a+" es: "+Math.cos(b));//calcula coseno y muestra el resultado
        System.out.println("El seno de "+a+" es: "+(Math.sin(b)));//calcula seno y muestra el resultado
        System.out.println("La tangente de "+a+" es: "+(Math.tan(b)));//calcula tangente y muestra el resultado
    }
}